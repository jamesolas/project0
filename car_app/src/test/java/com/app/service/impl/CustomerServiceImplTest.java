...
class CustomerServiceImplTest {
	...
	void testViewOpenCars2() {
		...
		try {
			...
			try {
				assertNotNull(customerServiceImpl.viewOpenCars());
			} catch (BusinessException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}		
	...
	void testViewOwnedCars2() {
		...
		try {
			assertNotNull(customerServiceImpl.viewOwnedCars(userId));
		} catch (BusinessException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}	
	...
	@Test
	void testViewRemainingPayments2() {
		...
		try {
			assertNotNull(customerServiceImpl.viewRemainingPayments(userId));
		} catch (BusinessException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	void testMakePayment2() {
		...
		assertNotNull(customerServiceImpl.makePayment(userId, carId));	
	}
